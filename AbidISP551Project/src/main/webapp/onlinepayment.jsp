...
<body>
 <!-- Responsive navbar-->
	...
	<form action="OnlinePaymentController" method="post" enctype="multipart/form-data" style= "padding:50px 50px 50px 50px; text-align:auto;">
		<table>
			<tr>
		...
		<tr>
			<td id="col-span-25">Transaction receipt</td>
			<td id="col-span-75">:&nbsp;
