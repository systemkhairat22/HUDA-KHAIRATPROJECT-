...
import admin.dao.*;
import user.model.*;
@WebServlet("/ManageProfileSupervisorController")
public class ManageProfileSupervisorController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private DaoAdmin dao;
    
    public ManageProfileSupervisorController() {
        super();
        dao = new DaoAdmin();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("managesupervisor.jsp");
