        ...
        <div class="nav">
              ...
              <div class="nav-header">
                <div class="nav-title d-flex align-items-center">
                  <p class="mb-brand">List Payment</p>
                </div>
              </div>
              <div class="nav-btn">
                <label for="nav-check">
              ...
              <div class="nav-links">
                ...
                <a href= " createmember.jsp">Create New Member</a>  
	...
	<table border="1">
		...
		<c:forEach items ="${payment}" var="p">
			<tr>
				...
				<td><a class="btn btn-primary" href="DeletePaymentController?paymentid=<c:out value="${p.paymentid}"/>">Payment receive</a></td>
			</tr>
		</c:forEach>
	</table>
	</form>
