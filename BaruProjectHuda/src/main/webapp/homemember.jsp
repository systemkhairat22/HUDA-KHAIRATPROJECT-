 ...
 <!-- Responsive navbar-->
	...
	<table>
		...
		<tr>
			...
			<td id="col-span-75">:&nbsp;<c:out value="${m.mem_age}"/>&nbsp;years old</td>
		</tr>
		
		<tr>
			<td id="col-span-25">Member Email</td>
			<td id="col-span-75">:&nbsp;<c:out value="${m.mem_email}"/></td>
		</tr>
		
		<tr>
			<td id="col-span-25">Phone Number</td>
			<td id="col-span-75">:&nbsp;<c:out value="${m.mem_password}"/></td>
		</tr>
		
		<tr>
			<td id="col-span-25">Member password</td>
			<td id="col-span-75">:&nbsp;<c:out value="${m.mem_phonenum}"/></td>
		</tr>
		<tr>
			<td id="col-span-25">Representative Name</td>
			<td id="col-span-75">:&nbsp;<c:out value="${m.repname}"/></td>
		</tr>
		<tr>
			<td id="col-span-25">Representative Number</td>
			<td id="col-span-75">:&nbsp;<c:out value="${m.repnum}"/></td>
		</tr>
	
	</table>

	<br><br>
	<button onclick="document.location='ManageProfileMemberController'"style="margin-left:175px;">Edit</button>
	</form>
